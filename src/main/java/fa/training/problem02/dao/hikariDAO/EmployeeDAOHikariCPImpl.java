...
public class EmployeeDAOHikariCPImpl implements EmployeeDAO<Employee, Integer> {
...
//        connection = JDBCConnection.getConnection();
        ...
        try {
            Connection HikariConnection = HikariCP.getConnection();
            Employee employeeById = new Employee();
            PreparedStatement pst = HikariConnection.prepareStatement(SQLFindById);
            pst.setInt(1, emp_no);
